    ...
    return (
        <div className="container head d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center gap-3 social-search">
                ...
                <button className="btn btn-outline text-light" type="submit" style={{ backgroundColor: 'pink' }}><a href='#contact'>Search</a></button>
            </div>
            ...
            <ul className={`nav align-items-center ${isNavVisible ? 'show-nav' : ''}`}>
                <li className="nav-item">
                    <a className="nav-link active fw-bold text-light" aria-current="page" href="#about">Accueil</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link fw-bold text-light" href="#hero">Informations</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link fw-bold text-light" href="#services">Services</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link fw-bold text-light" href="#projets">Projects</a>
                </li>
                <li className="nav-item">
